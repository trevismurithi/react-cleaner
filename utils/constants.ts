...
export const URL_EXTRACT_REGEX = /url\((['"]?)([^"')]+)\1\)/gi;

// Normal image file regex
export const IMAGE_REGEX = /\.(png|jpe?g|svg|gif|webp|ico|avif)$/i;

export const REACT_ENTRY_FILES = [
  "index.js",
  "index.jsx",
  "index.ts",
  "index.tsx",
...
export const EXTENSIONS_TO_EXCLUDE = [
  "test.tsx",
  "test.ts",
  "test.js",
  "test.jsx",
...
export const DIRECTORIES_TO_EXCLUDE = [
  "node_modules",
  "dist",
  "build",
  "dist",
