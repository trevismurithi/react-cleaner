 ...
 */
export const MEDIUM_RISK_CONSOLE_ARG_REGEXES: RegExp[] = [
...
export const CONSOLE_LOG_MEDIUM_RISK_CATEGORY_LABELS: string[] = [
  "Stable identifiers & tenancy",
  "Request tracing & HTTP metadata",
  "URLs & API surfaces (without embedded user:pass@)",
  "Errors & diagnostics",
 ...
 */
export function matchesMediumRiskConsoleArgText(text: unknown): boolean {
