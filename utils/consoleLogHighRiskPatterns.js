 ...
 */
const HIGH_RISK_CONSOLE_ARG_REGEXES = [
...
const CONSOLE_LOG_HIGH_RISK_CATEGORY_LABELS = [
  "Passwords & authentication",
  "Secrets, keys, signing",
  "API keys & headers",
  "Tokens (named & camelCase)",
 ...
 * @returns {boolean}
 */
function matchesHighRiskConsoleArgText(text) {
...
module.exports = {
  HIGH_RISK_CONSOLE_ARG_REGEXES,
  matchesHighRiskConsoleArgText,
